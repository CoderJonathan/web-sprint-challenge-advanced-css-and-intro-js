...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 3: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀  
 ...
 Example, if getArtistByIndex is invoked with the artists array and the number 0, it will return `the artist at index 0 is Amedeo Modigliani` */
  ...
  const getArtistByIndexResult = artists[index].name;
...
Example: addArtist(artists) should return the artists array with the above object added to the end of the array. */
  ...
  function addArtist(artArr, id, bio, name, genre, years, nationality){
    artArr.push(id, name, years, genre, nationality, bio)
    return artArr
  }

console.log(addArtist(artists,"id; 19", "name: Jonathan Garcia", "years: 2001 - current day", "genre: Web Design", "nationality: Mexican-American", "bio: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi quis nulla neque. Quisque commodo orci sed leo laoreet, eu posuere mauris ullamcorper." ))
